...
public class LocatorTemplate : CodeTemplateBase
{
    ...
    string Locator() => $$"""
        ...
        {
            public {{context.SubclassType.CSharpFriendlyFullName}} Locate(Id id, bool throwNotFound) =>
            ...
            public LazyLocatable<{{context.SubclassType.CSharpFriendlyFullName}}> LocateLazily(Id _) =>
            ...
            public IEnumerable<{{context.SubclassType.CSharpFriendlyFullName}}> LocateMany(IEnumerable<Id> ids) =>
